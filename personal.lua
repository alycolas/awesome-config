...
cputext_format = " $2% $3%" -- %1 average cpu, %[2..] every other thread individually
...
networks = {'enp1s6'} -- Add your devices network interface here netwidget, only show one that works
